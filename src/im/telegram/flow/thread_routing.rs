//! Telegram Thread routing: route/turn steering, routing-result delivery, thread list, thread creation and route selection messages.
//!
...
pub(super) enum TelegramThreadRoutingResultDelivery {
    Updated,
    SentAsNew {
        message_id: String,
        update_error: String,
...
pub(super) trait TelegramThreadRoutingResultSender: Sync {
...
pub(super) async fn deliver_telegram_thread_routing_result(
...
pub(super) async fn steer_telegram_turn(
    state: &SharedState,
    adapter: &TelegramAdapter,
...
pub(super) async fn create_telegram_thread_for_route(
    state: &SharedState,
    adapter: &TelegramAdapter,
    message: &InboundMessage,
...
pub(super) async fn handle_telegram_thread_route_choice(
    state: SharedState,
    adapter: TelegramAdapter,
    message: InboundMessage,
    request_id: &str,
...
pub(super) async fn checked_telegram_thread_routing_request(
    state: &SharedState,
    adapter: &TelegramAdapter,
    message: &InboundMessage,
    request_id: &str,
...
pub(super) async fn handle_telegram_thread_list_text_reply(
    state: SharedState,
    adapter: TelegramAdapter,
    message: InboundMessage,
    command: &str,
...
pub(super) async fn handle_telegram_thread_create_option_text_reply(
    state: SharedState,
    adapter: TelegramAdapter,
    message: InboundMessage,
    command: &str,
...
pub(super) async fn handle_telegram_thread_create_text_input(
    state: &SharedState,
    adapter: &TelegramAdapter,
    message: &InboundMessage,
    text: &str,
...
pub(super) async fn send_telegram_thread_create_custom_cwd_prompt(
    state: &SharedState,
    adapter: &TelegramAdapter,
    message: &InboundMessage,
) -> Result<()> {
...
pub(super) async fn send_telegram_thread_routing_choice(
    state: &SharedState,
    adapter: &TelegramAdapter,
    message: &InboundMessage,
...
pub(super) async fn send_telegram_thread_create_settings(
    state: &SharedState,
    adapter: &TelegramAdapter,
    message: &InboundMessage,
    existing_request: Option<ThreadRoutingRequestState>,
...
pub(super) async fn send_telegram_thread_create_options(
    state: &SharedState,
    adapter: &TelegramAdapter,
    message: &InboundMessage,
...
pub(super) async fn send_telegram_thread_routing_list(
    state: &SharedState,
    adapter: &TelegramAdapter,
    message: &InboundMessage,
    existing_request: Option<ThreadRoutingRequestState>,
...
pub(super) async fn handle_telegram_thread_route_list_page(
    state: SharedState,
    adapter: TelegramAdapter,
    message: InboundMessage,
    request_id: &str,
...
pub(super) async fn handle_telegram_thread_route_resume_selected(
    state: SharedState,
    adapter: TelegramAdapter,
    message: InboundMessage,
    request_id: &str,
