...
// StyledTextCtrl events - only available when stc feature is enabled
    ...
    WXD_EVENT_TYPE_TASKBAR_CLICK = 339,               // wxEVT_TASKBAR_CLICK

// WebView event types - only available when webview feature is enabled
#if wxdUSE_WEBVIEW
    WXD_EVENT_TYPE_WEBVIEW_CREATED = 340,                // wxEVT_WEBVIEW_CREATED
    WXD_EVENT_TYPE_WEBVIEW_NAVIGATING = 341,             // wxEVT_WEBVIEW_NAVIGATING
    WXD_EVENT_TYPE_WEBVIEW_NAVIGATED = 342,              // wxEVT_WEBVIEW_NAVIGATED
    WXD_EVENT_TYPE_WEBVIEW_LOADED = 343,                 // wxEVT_WEBVIEW_LOADED
    WXD_EVENT_TYPE_WEBVIEW_ERROR = 344,                  // wxEVT_WEBVIEW_ERROR
    WXD_EVENT_TYPE_WEBVIEW_NEWWINDOW = 345,              // wxEVT_WEBVIEW_NEWWINDOW
    WXD_EVENT_TYPE_WEBVIEW_NEWWINDOW_FEATURES = 346,     // wxEVT_WEBVIEW_NEWWINDOW_FEATURES
    WXD_EVENT_TYPE_WEBVIEW_TITLE_CHANGED = 347,          // wxEVT_WEBVIEW_TITLE_CHANGED
    WXD_EVENT_TYPE_WEBVIEW_FULLSCREEN_CHANGED = 348,     // wxEVT_WEBVIEW_FULLSCREEN_CHANGED
    WXD_EVENT_TYPE_WEBVIEW_SCRIPT_MESSAGE_RECEIVED = 349,// wxEVT_WEBVIEW_SCRIPT_MESSAGE_RECEIVED
    WXD_EVENT_TYPE_WEBVIEW_SCRIPT_RESULT = 350,          // wxEVT_WEBVIEW_SCRIPT_RESULT
    WXD_EVENT_TYPE_WEBVIEW_WINDOW_CLOSE_REQUESTED = 351, // wxEVT_WEBVIEW_WINDOW_CLOSE_REQUESTED
    WXD_EVENT_TYPE_WEBVIEW_BROWSING_DATA_CLEARED = 352,  // wxEVT_WEBVIEW_BROWSING_DATA_CLEARED
#endif

    // NEW: Menu event types
    WXD_EVENT_TYPE_MENU_OPEN = 360,      // wxEVT_MENU_OPEN
    WXD_EVENT_TYPE_MENU_CLOSE = 361,     // wxEVT_MENU_CLOSE
...
typedef struct wxd_LanguageInfo_t wxd_LanguageInfo_t;
typedef struct wxd_UILocale_t wxd_UILocale_t;
