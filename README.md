...
官方 Codex App 在 macOS 和新版 Windows 版都支持 remote-control。本项目只写入 Codex App 读取的本地配置和 GUI 环境入口，不替换 App 或 CLI 可执行文件。
...
- macOS 或 Windows 设备
- OpenAI 官方 Codex App（Windows 需要支持 remote-control 的新版 Codex App）
